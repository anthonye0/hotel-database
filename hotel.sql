...
VALUES
    ('a1b2c3d5-e5f6-4a78-af61-f8f0f5a76b29', 'Berlin', '10117', 'Albrechtstraße', '5'),
    ('b2c3d4e6-f6a7-4dc9-a6fc-9f1350d477d5', 'Berlin', '13353', 'Müllerstraße', '151a'),
    ('c3d4e5f7-a7b8-4d4e-9eeb-51d4aee9c12d', 'Berlin', '10439', 'Bjoernsonstraße', '10'),
    ('d4e5f6a8-b8c9-439e-9a91-8b3ac71a9055', 'München', '81829', 'Willy-Brandt-Platz', '3'),
    ('e5f6a7b9-c9d0-4d1c-aa88-7ac102c8ed29', 'München', '80636', 'Albrechtstraße', '13');
    
    
    
ALTER TABLE Hotel ADD COLUMN  OrtID UUID;

UPDATE Hotel SET OrtID = 'a1b2c3d5-e5f6-4a78-af61-f8f0f5a76b29' WHERE HotelID ='1001';
UPDATE Hotel SET OrtID = 'b2c3d4e6-f6a7-4dc9-a6fc-9f1350d477d5' WHERE HotelID ='1002';
UPDATE Hotel SET OrtID = 'b2c3d4e6-f6a7-4dc9-a6fc-9f1350d477d5' WHERE HotelID='1003';
UPDATE Hotel SET OrtID = 'c3d4e5f7-a7b8-4d4e-9eeb-51d4aee9c12d' WHERE HotelID ='1004';
UPDATE Hotel SET OrtID = 'd4e5f6a8-b8c9-439e-9a91-8b3ac71a9055' WHERE HotelID ='1005';
UPDATE Hotel SET OrtID = 'e5f6a7b9-c9d0-4d1c-aa88-7ac102c8ed29' WHERE HotelID ='1006';
